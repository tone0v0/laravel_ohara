                      ...
                      <div class="container px-5 py-24 mx-auto">
                        ...
                        <div class="lg:w-1/2 md:w-2/3 mx-auto">
                          ...
                          <div class="m-2">
                            ...
                            {{-- 編集ボタン --}}
                            <div class="p-2 w-full">
                              <button type="button" onclick="location.href='{{route('')}}'" class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">編集</button>
                            </div>
